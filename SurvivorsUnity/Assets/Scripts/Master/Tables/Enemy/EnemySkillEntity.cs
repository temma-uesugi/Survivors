...
namespace Master.Tables.Enemy
{
    ...
    /// 敵スキル
    /// </summary>
    [MemoryTable("EnemySkillEntity"), MessagePackObject(true)]
    public class EnemySkillEntity
    {
        ...
        public EnemySkillEntity(uint SkillId, int MinRange, int MaxRange, bool IsIgnoreObstacles, int Effect1, int Effect2, int Effect3, int Effect4, int Effect5, string ImageId)
        {
