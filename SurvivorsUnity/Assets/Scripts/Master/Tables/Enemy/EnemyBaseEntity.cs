...
namespace Master.Tables.Enemy
{
    ...
    /// 敵基本
    /// </summary>
    [MemoryTable("EnemyBaseEntity"), MessagePackObject(true)]
    public class EnemyBaseEntity
    {
        ...
        public EnemyBaseEntity(uint EnemyId, string EnemyName, int ActionInterval, int MovePower, uint SkillSetId, EnemyActiveConditionType ActiveConditionType, int ActiveConditionValue, EnemyInactiveConditionType InactiveConditionType, int InactiveConditionValue, bool IsFlight, string ImageId)
        {
