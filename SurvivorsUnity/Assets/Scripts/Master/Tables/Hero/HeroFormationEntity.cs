...
namespace Master.Tables.Hero
{
    ...
    /// 味方陣形
    /// </summary>
    [MemoryTable("HeroFormationEntity"), MessagePackObject(true)]
    public class HeroFormationEntity
    {
        ...
        public HeroFormationEntity(uint FormationId, string Name, string Description, float FrontDamageCutCoef, float SideDamageCutCoef, float BackDamageCutCoef, float BonusHpCoef, float BonusDamageCutCoef)
        {
