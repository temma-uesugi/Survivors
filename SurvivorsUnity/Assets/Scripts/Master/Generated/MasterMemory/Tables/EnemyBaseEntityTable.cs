...
{
   public sealed partial class EnemyBaseEntityTable : TableBase<EnemyBaseEntity>, ITableUniqueValidate
   {
        ...
        public EnemyBaseEntityTable(EnemyBaseEntity[] sortedData)
            : base(sortedData)
        {
        ...
        {
            return new MasterMemory.Meta.MetaTable(typeof(EnemyBaseEntity), typeof(EnemyBaseEntityTable), "EnemyBaseEntity",
