...
{
   public sealed partial class EnemySkillSetEntityTable : TableBase<EnemySkillSetEntity>, ITableUniqueValidate
   {
        ...
        public EnemySkillSetEntityTable(EnemySkillSetEntity[] sortedData)
            : base(sortedData)
        {
        ...
        {
            return new MasterMemory.Meta.MetaTable(typeof(EnemySkillSetEntity), typeof(EnemySkillSetEntityTable), "EnemySkillSetEntity",
