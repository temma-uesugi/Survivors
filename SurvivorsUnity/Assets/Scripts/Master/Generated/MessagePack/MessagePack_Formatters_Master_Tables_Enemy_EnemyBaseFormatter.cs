...
namespace MessagePack.Formatters.Master.Tables.Enemy
{
    public sealed class EnemyBaseFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Master.Tables.Enemy.EnemyBase>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Master.Tables.Enemy.EnemyBase value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<EnemyActiveConditionType>(formatterResolver).Serialize(ref writer, value.ActiveConditionType, options);
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<EnemyInactiveConditionType>(formatterResolver).Serialize(ref writer, value.InactiveConditionType, options);
        ...
        public global::Master.Tables.Enemy.EnemyBase Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var __ActiveConditionType__ = default(EnemyActiveConditionType);
            var __ActiveConditionValue__ = default(int);
            var __InactiveConditionType__ = default(EnemyInactiveConditionType);
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (stringKey.Length)
                {
                    ...
                    case 19:
                        ...
                        __ActiveConditionType__ = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<EnemyActiveConditionType>(formatterResolver).Deserialize(ref reader, options);
                        continue;
                    case 20:
                    ...
                    case 21:
                        ...
                        __InactiveConditionType__ = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<EnemyInactiveConditionType>(formatterResolver).Deserialize(ref reader, options);
                        continue;
                    case 22:
