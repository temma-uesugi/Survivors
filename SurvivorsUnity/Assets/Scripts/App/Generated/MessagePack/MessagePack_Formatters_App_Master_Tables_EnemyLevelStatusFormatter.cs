...
{
    public sealed class EnemyLevelStatusFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::App.Master.Tables.EnemyLevelStatus>
    {
        // EnemyId
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::App.Master.Tables.EnemyLevelStatus value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value is null)
            {
                writer.WriteNil();
        ...
        public global::App.Master.Tables.EnemyLevelStatus Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            var ____result = new global::App.Master.Tables.EnemyLevelStatus();
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                switch (stringKey.Length)
                {
                    ...
                    case 19:
                        switch (global::MessagePack.Internal.AutomataKeyGen.GetKey(ref stringKey))
                        {
                            ...
                            case 8377104752138414404UL:
                                ...
                                ____result.DirectAttackDefense = reader.ReadInt32();
                                continue;
                            ...
                            case 8377087168575594834UL:
                                ...
                                ____result.RangedAttackDefense = reader.ReadInt32();
                                continue;
                    ...
                    case 11:
                        ...
                        ____result.AttackPower = reader.ReadInt32();
                        continue;
