...
namespace App.Battle2.Core
{
    ...
    /// Note: Donuts.AM3から
    /// </summary>
    public class AsyncMessageBroker2 : IDisposable
    {
        ...
        {
            readonly AsyncMessageBroker2 _parent;
            readonly Func<T, UniTask> _asyncMessageReceiver;

            public Subscription(AsyncMessageBroker2 parent, Func<T, UniTask> asyncMessageReceiver)
            {
                _parent = parent;
