...
namespace App.Battle2.Units.Enemy
{
    ...
    /// 船のModel
    /// </summary>
    public class EnemyUnitModel : IUnitModel, IAttackTargetModel, IBlockBombModel
    {
        ...
        //攻撃の対象としている船
        private readonly ReactiveProperty<ShipUnitModel> _targetUnit = new();
        public IReadOnlyReactiveProperty<ShipUnitModel> TargetUnit => _targetUnit;
        //Activeか
        ...
        /// ターゲットをセット
        /// </summary>
        public void SetTarget(ShipUnitModel shipUnitModel)
        {
            _targetUnit.Value = shipUnitModel;
        }
